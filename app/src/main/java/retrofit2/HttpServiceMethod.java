...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            try {
                return this.isNullable ? KotlinExtensions.awaitNullable(callAdapt, cVar) : KotlinExtensions.await(callAdapt, cVar);
            } catch (Exception e10) {
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            c cVar = (c) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(callAdapt, cVar);
            } catch (Exception e10) {
                return KotlinExtensions.suspendAndThrow(e10, cVar);
            }
        }
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        if (typeResponseType == okhttp3.Response.class) {
            throw Utils.methodError(method, ac.c.d(Utils.getRawType(typeResponseType), new StringBuilder("'"), "' is not a valid response body type. Did you mean ResponseBody?"), new Object[0]);
        }
        ...
        return !z11 ? new CallAdapted(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter) : z10 ? new SuspendForResponse(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter) : new SuspendForBody(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter, false);
    }
