...
final class RequestBuilder {
    ...
    private static String canonicalizeForPath(String str, boolean z10) {
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z10 && (iCodePointAt == 47 || iCodePointAt == 37))) {
                ...
                canonicalizeForPath(cVar, str, iCharCount, length, z10);
    ...
    public void addHeader(String str, String str2) {
        ...
        try {
            ...
            throw new IllegalArgumentException(ac.c.j("Malformed content type: ", str2), e10);
        }
    }
    ...
    public void addPathParam(String str, String str2, boolean z10) {
        ...
        if (PATH_TRAVERSAL.matcher(strReplace).matches()) {
            throw new IllegalArgumentException(ac.c.j("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
