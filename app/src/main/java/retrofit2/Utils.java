...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return c.o(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static Type getParameterUpperBound(int i10, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbS = c.s("Index ", i10, " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, int i10, String str, Object... objArr) {
        StringBuilder sbU = c.u(str, " (parameter #");
        sbU.append(i10 + 1);
        sbU.append(")");
        return methodError(method, sbU.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th2, String str, Object... objArr) {
        StringBuilder sbU = c.u(String.format(str, objArr), "\n    for method ");
        sbU.append(method.getDeclaringClass().getSimpleName());
        sbU.append(".");
        sbU.append(method.getName());
        return new IllegalArgumentException(sbU.toString(), th2);
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th2, int i10, String str, Object... objArr) {
        ...
        sbU.append(i10 + 1);
        sbU.append(")");
        return methodError(method, th2, sbU.toString(), objArr);
    }
}
