...
public final class b implements d {
    ...
    public List<b6.a> getCues(long j10) {
        b6.a aVar;
        int iBinarySearchFloor = u.binarySearchFloor(this.f11522m, j10, true, false);
        return (iBinarySearchFloor == -1 || (aVar = this.f11521b[iBinarySearchFloor]) == null) ? Collections.emptyList() : Collections.singletonList(aVar);
    }
