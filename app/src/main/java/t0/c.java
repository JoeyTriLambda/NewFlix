    ...
    public static final Bundle bundleOf(Pair<String, ? extends Object>... pairArr) {
        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (objComponent2 == null) {
                ...
                zf.i.checkNotNull(componentType);
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    zf.i.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(strComponent1, (Parcelable[]) objComponent2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    zf.i.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(strComponent1, (String[]) objComponent2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    zf.i.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                ...
                b.putSize(bundle, strComponent1, (Size) objComponent2);
            } else {
                ...
                b.putSizeF(bundle, strComponent1, (SizeF) objComponent2);
            }
        }
        return bundle;
    }
