    ...
    public static final class Field implements TemporalField {
        ...
        public <R extends Temporal> R adjustInto(R r10, long j10) {
            if (range().isValidValue(j10)) {
                return (R) r10.with(ChronoField.EPOCH_DAY, Jdk8Methods.safeSubtract(j10, this.offset));
            }
            throw new DateTimeException("Invalid value: " + this.name + StringUtils.SPACE + j10);
        }
