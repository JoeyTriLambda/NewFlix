...
public final class ThaiBuddhistChronology extends Chronology implements Serializable {
    ...
    public ThaiBuddhistDate resolveDate(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(chronoField7)) {
            ...
            if (map.containsKey(chronoField9)) {
                ...
                if (map.containsKey(chronoField10)) {
                    ...
                    ThaiBuddhistDate thaiBuddhistDatePlus = date(iCheckValidIntValue4, iCheckValidIntValue5, 1).plus((chronoField10.checkValidIntValue(map.remove(chronoField10).longValue()) - 1) + ((chronoField9.checkValidIntValue(map.remove(chronoField9).longValue()) - 1) * 7), (TemporalUnit) ChronoUnit.DAYS);
        ...
        if (map.containsKey(chronoField14)) {
            ...
            ThaiBuddhistDate thaiBuddhistDatePlusDays = date(iCheckValidIntValue9, 1, 1).plusDays((chronoField14.checkValidIntValue(map.remove(chronoField14).longValue()) - 1) + ((chronoField13.checkValidIntValue(map.remove(chronoField13).longValue()) - 1) * 7));
    ...
    @Override // org.threeten.bp.chrono.Chronology
    public ThaiBuddhistDate dateYearDay(Era era, int i10, int i11) {
        return (ThaiBuddhistDate) super.dateYearDay(era, i10, i11);
    }

    @Override // org.threeten.bp.chrono.Chronology
    public ThaiBuddhistDate date(Era era, int i10, int i11, int i12) {
        return (ThaiBuddhistDate) super.date(era, i10, i11, i12);
    }
