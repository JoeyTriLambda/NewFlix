...
public abstract class ChronoLocalDate extends DefaultInterfaceTemporal implements TemporalAdjuster, Comparable<ChronoLocalDate> {
    ...
    public abstract ChronoLocalDate plus(long j10, TemporalUnit temporalUnit);
    ...
    @Override // org.threeten.bp.temporal.Temporal
    public abstract ChronoLocalDate with(TemporalField temporalField, long j10);

    @Override // java.lang.Comparable
    public int compareTo(ChronoLocalDate chronoLocalDate) {
        int iCompareLongs = Jdk8Methods.compareLongs(toEpochDay(), chronoLocalDate.toEpochDay());
        return iCompareLongs == 0 ? getChronology().compareTo(chronoLocalDate.getChronology()) : iCompareLongs;
    }
    ...
    public ChronoLocalDate minus(long j10, TemporalUnit temporalUnit) {
        return getChronology().ensureChronoLocalDate(super.minus(j10, temporalUnit));
    }
}
