...
public abstract class Chronology implements Comparable<Chronology> {
    ...
    public static Chronology of(String str) {
        ...
        throw new DateTimeException(c.j("Unknown chronology: ", str));
    }
    ...
    public abstract ChronoLocalDate date(int i10, int i11, int i12);

    public ChronoLocalDate date(Era era, int i10, int i11, int i12) {
        return date(prolepticYear(era, i10), i11, i12);
    }

    public abstract ChronoLocalDate date(TemporalAccessor temporalAccessor);

    public abstract ChronoLocalDate dateEpochDay(long j10);

    public ChronoLocalDate dateNow() {
        return dateNow(Clock.systemDefaultZone());
    }

    public abstract ChronoLocalDate dateYearDay(int i10, int i11);

    public ChronoLocalDate dateYearDay(Era era, int i10, int i11) {
    ...
    public ChronoPeriod period(int i10, int i11, int i12) {
    ...
    public void updateResolveMap(Map<TemporalField, Long> map, ChronoField chronoField, long j10) {
        ...
        throw new DateTimeException("Invalid state, field: " + chronoField + StringUtils.SPACE + l10 + " conflicts with " + chronoField + StringUtils.SPACE + j10);
    }
    ...
    public ChronoZonedDateTime<?> zonedDateTime(TemporalAccessor temporalAccessor) {
        try {
            ...
            try {
                ...
                return ChronoZonedDateTimeImpl.ofBest(ensureChronoLocalDateTime(localDateTime(temporalAccessor)), zoneIdFrom, null);
            }
        } catch (DateTimeException e10) {
