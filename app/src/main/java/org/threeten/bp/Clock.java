    ...
    public static final class TickClock extends Clock implements Serializable {
        ...
        public Instant instant() {
            if (this.tickNanos % 1000000 == 0) {
                ...
                return Instant.ofEpochMilli(jMillis - Jdk8Methods.floorMod(jMillis, this.tickNanos / 1000000));
            }
        ...
        public long millis() {
            long jMillis = this.baseClock.millis();
            return jMillis - Jdk8Methods.floorMod(jMillis, this.tickNanos / 1000000);
        }
