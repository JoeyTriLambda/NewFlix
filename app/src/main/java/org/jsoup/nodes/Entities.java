...
public final class Entities {
    ...
    public static final char[] f17147a = {',', ';'};

    /* renamed from: b, reason: collision with root package name */
    public static final HashMap<String, String> f17148b = new HashMap<>();
    ...
    public enum EscapeMode {
        ...
        EscapeMode(String str, int i10) throws IOException, NumberFormatException {
            int i11;
            char[] cArr = Entities.f17147a;
            this.f17157b = new String[i10];
            this.f17158m = new int[i10];
            this.f17159n = new int[i10];
            this.f17160o = new String[i10];
            gh.a aVar = new gh.a(str);
            int i12 = 0;
            while (!aVar.isEmpty()) {
                String strConsumeTo = aVar.consumeTo('=');
                aVar.advance();
                int i13 = Integer.parseInt(aVar.consumeToAny(Entities.f17147a), 36);
                char cCurrent = aVar.current();
                aVar.advance();
                if (cCurrent == ',') {
                    i11 = Integer.parseInt(aVar.consumeTo(';'), 36);
                    aVar.advance();
                } else {
                    i11 = -1;
                }
                int i14 = Integer.parseInt(aVar.consumeTo('&'), 36);
                aVar.advance();
                this.f17157b[i12] = strConsumeTo;
                this.f17158m[i12] = i13;
                this.f17159n[i14] = i13;
                this.f17160o[i14] = strConsumeTo;
                if (i11 != -1) {
                    Entities.f17148b.put(strConsumeTo, new String(new int[]{i13, i11}, 0, 2));
                }
                i12++;
            }
            dh.f.isTrue(i12 == i10, "Unexpected count of entities loaded");
        }
    }
    ...
    */
    public static void a(java.lang.Appendable r4, org.jsoup.nodes.Entities.EscapeMode r5, int r6) throws java.io.IOException {
        /*
            int[] r0 = r5.f17159n
            int r0 = java.util.Arrays.binarySearch(r0, r6)
            java.lang.String r1 = ""
            if (r0 < 0) goto L1f
            java.lang.String[] r2 = r5.f17160o
            int r3 = r2.length
            int r3 = r3 + (-1)
            if (r0 >= r3) goto L1c
            int[] r5 = r5.f17159n
        ...
        L43:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jsoup.nodes.Entities.a(java.lang.Appendable, org.jsoup.nodes.Entities$EscapeMode, int):void");
    }
    ...
    */
    public static void b(java.lang.Appendable r10, java.lang.String r11, org.jsoup.nodes.Document.OutputSettings r12, boolean r13, boolean r14) throws java.io.IOException {
        /*
            ...
            java.lang.ThreadLocal<java.nio.charset.CharsetEncoder> r1 = r12.f17128n
            java.lang.Object r1 = r1.get()
            java.nio.charset.CharsetEncoder r1 = (java.nio.charset.CharsetEncoder) r1
            if (r1 == 0) goto Lf
            goto L13
        Lf:
            java.nio.charset.CharsetEncoder r1 = r12.a()
        L13:
            org.jsoup.nodes.Entities$CoreCharset r12 = r12.f17129o
            int r2 = r11.length()
            r3 = 0
            r4 = 0
            r5 = 0
        L1c:
            ...
            r7 = 1
            if (r14 == 0) goto L38
            boolean r8 = dh.e.isWhitespace(r6)
            if (r8 == 0) goto L37
            if (r5 == 0) goto L2f
            goto Lc3
        L2f:
    ...
    public static int codepointsForName(String str, int[] iArr) {
        ...
        int iBinarySearch = Arrays.binarySearch(escapeMode.f17157b, str);
        int i10 = iBinarySearch >= 0 ? escapeMode.f17158m[iBinarySearch] : -1;
        if (i10 == -1) {
            return 0;
        }
        iArr[0] = i10;
    ...
    public static boolean isBaseNamedEntity(String str) {
        ...
        int iBinarySearch = Arrays.binarySearch(escapeMode.f17157b, str);
        return (iBinarySearch >= 0 ? escapeMode.f17158m[iBinarySearch] : -1) != -1;
    }
