...
public class Conversion {
    ...
    */
    ...
    public static char intToHexDigit(int i10) {
        char cForDigit = Character.forDigit(i10, 16);
        if (cForDigit != 0) {
            return cForDigit;
        }
        throw new IllegalArgumentException(c.f("nibble value not between 0 and 15: ", i10));
    }
    ...
    public static short[] intToShortArray(int i10, int i11, short[] sArr, int i12, int i13) {
        ...
        if (c.A(i13, -1, 16, i11) >= 32) {
            throw new IllegalArgumentException("(nShorts-1)*16+srcPos is greater or equal to than 32");
        }
        for (int i14 = 0; i14 < i13; i14++) {
            sArr[i12 + i14] = (short) ((i10 >> ((i14 * 16) + i11)) & Settings.DEFAULT_INITIAL_WINDOW_SIZE);
        }
        return sArr;
    }
    ...
    public static short[] longToShortArray(long j10, int i10, short[] sArr, int i11, int i12) {
        ...
        if (c.A(i12, -1, 16, i10) >= 64) {
            throw new IllegalArgumentException("(nShorts-1)*16+srcPos is greater or equal to than 64");
        }
        for (int i13 = 0; i13 < i12; i13++) {
            sArr[i11 + i13] = (short) (WebSocketProtocol.PAYLOAD_SHORT_MAX & (j10 >> ((i13 * 16) + i10)));
        }
        return sArr;
    }
    ...
    public static int shortArrayToInt(short[] sArr, int i10, int i11, int i12, int i13) {
        ...
        if (c.A(i13, -1, 16, i12) >= 32) {
            throw new IllegalArgumentException("(nShorts-1)*16+dstPos is greater or equal to than 32");
        }
        for (int i14 = 0; i14 < i13; i14++) {
            int i15 = (i14 * 16) + i12;
            i11 = (i11 & (~(Settings.DEFAULT_INITIAL_WINDOW_SIZE << i15))) | ((sArr[i14 + i10] & 65535) << i15);
        }
        return i11;
    }
    ...
    public static long shortArrayToLong(short[] sArr, int i10, long j10, int i11, int i12) {
        ...
        if (c.A(i12, -1, 16, i11) >= 64) {
            throw new IllegalArgumentException("(nShorts-1)*16+dstPos is greater or equal to than 64");
        }
        for (int i13 = 0; i13 < i12; i13++) {
            int i14 = (i13 * 16) + i11;
            j10 = (j10 & (~(WebSocketProtocol.PAYLOAD_SHORT_MAX << i14))) | ((sArr[i13 + i10] & WebSocketProtocol.PAYLOAD_SHORT_MAX) << i14);
        }
        return j10;
    }
    ...
    public static char binaryToHexDigit(boolean[] zArr, int i10) {
        ...
        if (zArr.length <= i11 || !zArr[i11]) {
            ...
            if (zArr.length <= i12 || !zArr[i12]) {
                int i13 = i10 + 1;
                return (zArr.length <= i13 || !zArr[i13]) ? zArr[i10] ? '1' : '0' : zArr[i10] ? '3' : '2';
            }
            int i14 = i10 + 1;
            return (zArr.length <= i14 || !zArr[i14]) ? zArr[i10] ? '5' : '4' : zArr[i10] ? '7' : '6';
        }
        int i15 = i10 + 2;
        if (zArr.length <= i15 || !zArr[i15]) {
            int i16 = i10 + 1;
            return (zArr.length <= i16 || !zArr[i16]) ? zArr[i10] ? '9' : '8' : zArr[i10] ? 'b' : 'a';
        }
        int i17 = i10 + 1;
        return (zArr.length <= i17 || !zArr[i17]) ? zArr[i10] ? 'd' : 'c' : zArr[i10] ? 'f' : 'e';
    }
