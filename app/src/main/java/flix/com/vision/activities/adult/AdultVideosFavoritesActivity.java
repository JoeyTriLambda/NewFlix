...
public class AdultVideosFavoritesActivity extends wb.a implements gd.a, b {
    ...
    public int V;
    public d W;
    public final ArrayList<id.b> M = new ArrayList<>();
    ...
    public void OnStreamResolvedSuccess(ArrayList<id.b> arrayList) {
        ...
        ArrayList<id.b> arrayList2 = this.M;
        arrayList2.clear();
    ...
    public void getVideos() {
        ArrayList<c> adultVideosFromDb = App.getInstance().f11573u.getAdultVideosFromDb();
        if (adultVideosFromDb != null && adultVideosFromDb.size() > 0) {
            this.R.addAll(adultVideosFromDb);
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.N.applyFontToView(this.Q, this.O);
        this.K.setOnClickListener(new androidx.mediarouter.app.b(this, 10));
        ...
        new Handler().postDelayed(new vb.d(this, 1), 1000L);
        setBackgroundColor();
        this.P.setText("Adult Zone · Favorites");
        getVideos();
    }

    public void onFavoritesLongPress(int i10) {
        ...
        dVarNewInstance.setButton1("REMOVE FAVORITE", new u(this, cVar, i10, 4));
        dVarNewInstance.setButton2("CANCEL", new q0(16));
        try {
    ...
    public void onMessageEvent(a aVar) {
        ...
        aVar.getClass();
        if (aVar.f11898a) {
            ArrayList<id.b> arrayList = this.M;
            ...
            aVar2.setSingleChoiceItems(charSequenceArr, -1, new o0(this, arrayList, 4));
            aVar2.setOnDismissListener(new p0(6));
            aVar2.show();
        }
    }
    ...
    public void setBackgroundColor() {
        ...
        valueAnimatorOfObject.addUpdateListener(new l7.a(this, 18));
