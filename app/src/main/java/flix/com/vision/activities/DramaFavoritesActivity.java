...
public class DramaFavoritesActivity extends wb.a implements e {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ArrayList<Drama> dramaFavorites = App.getInstance().f11573u.getDramaFavorites();
        this.L = dramaFavorites;
        m mVar = new m(dramaFavorites, this, this);
        this.M = mVar;
