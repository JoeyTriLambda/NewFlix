...
public final class d extends AsyncTask<Void, Void, String> {
    ...
    public final /* synthetic */ c f21067c;
    ...
    public String doInBackground(Void... voidArr) {
        ...
        c cVar = this.f21067c;
        cVar.getClass();
        if (RealDebridCommon.f12050o == null) {
            RealDebridCommon.f12050o = new ArrayDeque<>();
        }
        ArrayDeque<String> arrayDeque = RealDebridCommon.f12050o;
