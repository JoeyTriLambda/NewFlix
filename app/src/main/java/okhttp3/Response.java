...
public final class Response implements Closeable {
    ...
    public final ResponseBody m206deprecated_body() {
        return this.body;
    }

    /* renamed from: -deprecated_cacheControl, reason: not valid java name */
    public final CacheControl m207deprecated_cacheControl() {
        return cacheControl();
    }

    /* renamed from: -deprecated_cacheResponse, reason: not valid java name */
    public final Response m208deprecated_cacheResponse() {
        return this.cacheResponse;
    }

    /* renamed from: -deprecated_code, reason: not valid java name */
    public final int m209deprecated_code() {
        return this.code;
    }

    /* renamed from: -deprecated_handshake, reason: not valid java name */
    public final Handshake m210deprecated_handshake() {
        return this.handshake;
    }

    /* renamed from: -deprecated_headers, reason: not valid java name */
    public final Headers m211deprecated_headers() {
        return this.headers;
    }

    /* renamed from: -deprecated_message, reason: not valid java name */
    public final String m212deprecated_message() {
        return this.message;
    }

    /* renamed from: -deprecated_networkResponse, reason: not valid java name */
    public final Response m213deprecated_networkResponse() {
        return this.networkResponse;
    }

    /* renamed from: -deprecated_priorResponse, reason: not valid java name */
    public final Response m214deprecated_priorResponse() {
        return this.priorResponse;
    }

    /* renamed from: -deprecated_protocol, reason: not valid java name */
    public final Protocol m215deprecated_protocol() {
        return this.protocol;
    }

    /* renamed from: -deprecated_receivedResponseAtMillis, reason: not valid java name */
    public final long m216deprecated_receivedResponseAtMillis() {
        return this.receivedResponseAtMillis;
    }

    /* renamed from: -deprecated_request, reason: not valid java name */
    public final Request m217deprecated_request() {
        return this.request;
    }

    /* renamed from: -deprecated_sentRequestAtMillis, reason: not valid java name */
    public final long m218deprecated_sentRequestAtMillis() {
    ...
    public final ResponseBody peekBody(long j10) throws IOException {
        ResponseBody responseBody = this.body;
        i.checkNotNull(responseBody);
        e eVarPeek = responseBody.source().peek();
        c cVar = new c();
        eVarPeek.request(j10);
        cVar.write(eVarPeek, Math.min(j10, eVarPeek.getBuffer().size()));
    ...
    public static class Builder {
        ...
        private final void checkSupportResponse(String str, Response response) {
            ...
            if (!(response.body() == null)) {
                throw new IllegalArgumentException(i.stringPlus(str, ".body != null").toString());
            }
            if (!(response.networkResponse() == null)) {
                throw new IllegalArgumentException(i.stringPlus(str, ".networkResponse != null").toString());
            }
            if (!(response.cacheResponse() == null)) {
                throw new IllegalArgumentException(i.stringPlus(str, ".cacheResponse != null").toString());
            }
            if (!(response.priorResponse() == null)) {
                throw new IllegalArgumentException(i.stringPlus(str, ".priorResponse != null").toString());
            }
        }
        ...
        public Response build() {
            int i10 = this.code;
            if (!(i10 >= 0)) {
                throw new IllegalStateException(i.stringPlus("code < 0: ", Integer.valueOf(getCode$okhttp())).toString());
            }
        ...
        public final void initExchange$okhttp(Exchange exchange) {
            i.checkNotNullParameter(exchange, "deferredTrailers");
            this.exchange = exchange;
        }
