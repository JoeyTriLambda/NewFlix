...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z10) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            i.checkNotNullExpressionValue(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            i.checkNotNullExpressionValue(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, a.naturalOrder());
        } else {
            enabledProtocols = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        i.checkNotNullExpressionValue(supportedCipherSuites, "supportedCipherSuites");
        int iIndexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z10 && iIndexOf != -1) {
            i.checkNotNullExpressionValue(enabledCipherSuites, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            i.checkNotNullExpressionValue(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        i.checkNotNullExpressionValue(enabledProtocols, "tlsVersionsIntersection");
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        i.checkNotNullParameter(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            i.checkNotNullParameter(cipherSuiteArr, "cipherSuites");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections".toString());
            }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersionArr) {
            i.checkNotNullParameter(tlsVersionArr, "tlsVersions");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections".toString());
            }
        ...
        public final Builder cipherSuites(String... strArr) {
            i.checkNotNullParameter(strArr, "cipherSuites");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections".toString());
            }
            if (!(strArr.length == 0)) {
        ...
        public final Builder tlsVersions(String... strArr) {
            i.checkNotNullParameter(strArr, "tlsVersions");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections".toString());
            }
            if (!(strArr.length == 0)) {
