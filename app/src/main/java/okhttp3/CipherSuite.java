...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                i.checkNotNullParameter(str, "a");
                i.checkNotNullParameter(str2, "b");
                int iMin = Math.min(str.length(), str2.length());
                for (int i10 = 4; i10 < iMin; i10++) {
                    char cCharAt = str.charAt(i10);
                    char cCharAt2 = str2.charAt(i10);
                    if (cCharAt != cCharAt2) {
                        return i.compare((int) cCharAt, (int) cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public final String m115deprecated_javaName() {
