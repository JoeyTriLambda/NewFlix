...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m165deprecated_get(String str) {
            i.checkNotNullParameter(str, "mediaType");
            return get(str);
        }

        /* renamed from: -deprecated_parse, reason: not valid java name */
        public final MediaType m166deprecated_parse(String str) {
            i.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
        ...
        public final MediaType get(String str) {
            ...
            i.checkNotNullExpressionValue(strGroup, "typeSubtype.group(1)");
            ...
            i.checkNotNullExpressionValue(strGroup2, "typeSubtype.group(2)");
            i.checkNotNullExpressionValue(locale, "US");
            String lowerCase2 = strGroup2.toLowerCase(locale);
            i.checkNotNullExpressionValue(lowerCase2, "this as java.lang.String).toLowerCase(locale)");
            ...
            while (iEnd < str.length()) {
                ...
                if (strGroup3 == null) {
                    ...
                    } else if (l.startsWith$default(strGroup4, "'", false, 2, null) && l.endsWith$default(strGroup4, "'", false, 2, null) && strGroup4.length() > 2) {
                        strGroup4 = strGroup4.substring(1, strGroup4.length() - 1);
                        i.checkNotNullExpressionValue(strGroup4, "this as java.lang.String…ing(startIndex, endIndex)");
                    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof MediaType) && i.areEqual(((MediaType) obj).mediaType, this.mediaType);
    }
    ...
    public final String parameter(String str) {
        ...
        while (true) {
            int i11 = i10 + 2;
            if (l.equals(this.parameterNamesAndValues[i10], str, true)) {
