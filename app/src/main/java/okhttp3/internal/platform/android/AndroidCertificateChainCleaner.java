...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public AndroidCertificateChainCleaner(X509TrustManager x509TrustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        i.checkNotNullParameter(x509TrustManager, "trustManager");
        i.checkNotNullParameter(x509TrustManagerExtensions, "x509TrustManagerExtensions");
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws CertificateException, SSLPeerUnverifiedException {
        ...
        try {
            List<X509Certificate> listCheckServerTrusted = this.x509TrustManagerExtensions.checkServerTrusted((X509Certificate[]) array, JavaSignatureVerifier.KEY_ALGORITHM, str);
            i.checkNotNullExpressionValue(listCheckServerTrusted, "x509TrustManagerExtensio…ficates, \"RSA\", hostname)");
