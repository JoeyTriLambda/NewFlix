...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager x509TrustManager, Method method) {
            ...
            i.checkNotNullParameter(method, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object obj) {
            ...
            return i.areEqual(this.trustManager, customTrustRootIndex.trustManager) && i.areEqual(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }
    ...
    public AndroidPlatform() {
        List listListOfNotNull = k.listOfNotNull(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.Companion, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.Companion.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.Companion.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.Companion.getFactory()));
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager x509TrustManager) throws NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            i.checkNotNullExpressionValue(declaredMethod, "method");
