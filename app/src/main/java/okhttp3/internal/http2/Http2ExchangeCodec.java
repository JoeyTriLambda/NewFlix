...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            while (i10 < size) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (i.areEqual(lowerCase, Http2ExchangeCodec.TE) && i.areEqual(headers.value(i10), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headers, Protocol protocol) throws NumberFormatException, IOException {
            i.checkNotNullParameter(headers, "headerBlock");
            ...
            while (i10 < size) {
                ...
                if (i.areEqual(strName, Header.RESPONSE_STATUS_UTF8)) {
                    statusLine = StatusLine.Companion.parse(i.stringPlus("HTTP/1.1 ", strValue));
    ...
    public Http2ExchangeCodec(OkHttpClient okHttpClient, RealConnection realConnection, RealInterceptorChain realInterceptorChain, Http2Connection http2Connection) {
        ...
        i.checkNotNullParameter(http2Connection, "http2Connection");
    ...
    @Override // okhttp3.internal.http.ExchangeCodec
    public w createRequestBody(Request request, long j10) {
        i.checkNotNullParameter(request, "request");
        Http2Stream http2Stream = this.stream;
        i.checkNotNull(http2Stream);
