...
public final class Huffman {
    ...
    private final void addCode(int i10, int i11, int i12) {
        ...
        i.checkNotNull(children2);
        h.fill(children2, node, i15, (1 << i14) + i15);
    }

    public final void decode(e eVar, long j10, d dVar) throws IOException {
        ...
        while (j11 < j10) {
            j11++;
            iAnd = (iAnd << 8) | Util.and(eVar.readByte(), 255);
            terminalBitCount += 8;
    ...
    public final void encode(ByteString byteString, d dVar) throws IOException {
        i.checkNotNullParameter(byteString, "source");
        i.checkNotNullParameter(dVar, "sink");
    ...
    public final int encodedLength(ByteString byteString) {
        ...
        for (int i10 = 0; i10 < byteString.size(); i10++) {
            j10 += CODE_BIT_COUNTS[Util.and(byteString.getByte(i10), 255)];
        }
        return (int) ((j10 + 7) >> 3);
    }
