...
public final class RouteSelector {
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(InetSocketAddress inetSocketAddress) {
            i.checkNotNullParameter(inetSocketAddress, "<this>");
            InetAddress address = inetSocketAddress.getAddress();
            if (address == null) {
                String hostName = inetSocketAddress.getHostName();
                i.checkNotNullExpressionValue(hostName, "hostName");
                return hostName;
            }
            String hostAddress = address.getHostAddress();
            i.checkNotNullExpressionValue(hostAddress, "address.hostAddress");
            return hostAddress;
        }
    }
    ...
    public static final class Selection {
        ...
        public Selection(List<Route> list) {
            i.checkNotNullParameter(list, "routes");
            this.routes = list;
        }
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        ...
        i.checkNotNullParameter(routeDatabase, "routeDatabase");
        ...
        this.proxies = k.emptyList();
        this.inetSocketAddresses = k.emptyList();
    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (!(socketAddressAddress instanceof InetSocketAddress)) {
                throw new IllegalArgumentException(i.stringPlus("Proxy.address() is not an InetSocketAddress: ", socketAddressAddress.getClass()).toString());
            }
            Companion companion = Companion;
            i.checkNotNullExpressionValue(socketAddressAddress, "proxyAddress");
    ...
    private static final List<Proxy> resetNextProxy$selectProxies(Proxy proxy, HttpUrl httpUrl, RouteSelector routeSelector) {
        ...
        i.checkNotNullExpressionValue(listSelect, "proxiesOrNull");
    ...
    public final Selection next() throws IOException {
        ...
        if (arrayList.isEmpty()) {
            o.addAll(arrayList, this.postponedRoutes);
