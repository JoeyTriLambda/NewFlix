...
public class o extends ImageButton {
    ...
    public boolean hasOverlappingRendering() {
        return ((this.f1466m.f1488a.getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        p pVar = this.f1466m;
        if (pVar != null && drawable != null && !this.f1467n) {
    ...
    public void setImageResource(int i10) {
        this.f1466m.setImageResource(i10);
    }
