...
public final class j1 extends t0 {
    ...
    public final WeakReference<Context> f1415b;

    public j1(Context context, Resources resources) {
        super(resources);
        this.f1415b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) throws Resources.NotFoundException {
        Context context = this.f1415b.get();
        if (context == null) {
            return a(i10);
        }
        s0 s0Var = s0.get();
        synchronized (s0Var) {
            Drawable drawableH = s0Var.h(context, i10);
            if (drawableH == null) {
                drawableH = a(i10);
            }
            if (drawableH == null) {
            ...
            return s0Var.i(context, i10, false, drawableH);
        }
    }
