...
public interface Users {
    ...
    Call<List<HistoryEntry>> history(@Path("username") UserSlug userSlug, @Path("type") HistoryType historyType, @Path("id") int i10, @Query("page") Integer num, @Query("limit") Integer num2, @Query(encoded = true, value = "extended") Extended extended, @Query("start_at") OffsetDateTime offsetDateTime, @Query("end_at") OffsetDateTime offsetDateTime2);
