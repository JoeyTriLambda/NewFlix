...
public class Preferences {
    ...
    @WebViewExposed
    public static void setLong(String str, String str2, Long l10, WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
