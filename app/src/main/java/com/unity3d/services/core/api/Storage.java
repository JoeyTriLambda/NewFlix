...
public class Storage {
    ...
    @WebViewExposed
    public static void set(String str, String str2, Long l10, WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
