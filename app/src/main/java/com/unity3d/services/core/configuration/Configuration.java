...
public class Configuration {
    ...
    private void setOptionalFields(JSONObject jSONObject, boolean z10) {
        ...
        this._resetWebAppTimeout = jSONObject.optInt("rwt", AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT);
        ...
        this._connectedEventThresholdInMs = jSONObject.optInt("cet", AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT);
        this._maximumConnectedEvents = jSONObject.optInt("mce", 500);
        this._networkErrorTimeout = jSONObject.optLong("net", DateUtils.MILLIS_PER_MINUTE);
        this._sdkVersion = jSONObject.optString("sdkv", "");
        this._showTimeout = jSONObject.optInt("sto", AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT);
        ...
        this._webViewAppCreateTimeout = jSONObject.optLong("wct", DateUtils.MILLIS_PER_MINUTE);
        this._tokenTimeout = jSONObject.optInt("tto", 5000);
        this._privacyRequestWaitTimeout = jSONObject.optInt("prwto", HttpRequestExecutor.DEFAULT_WAIT_FOR_CONTINUE);
