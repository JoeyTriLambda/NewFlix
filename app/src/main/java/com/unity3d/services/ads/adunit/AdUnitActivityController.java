...
public class AdUnitActivityController {
    ...
    public boolean setSystemUiVisibility(int i10) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
