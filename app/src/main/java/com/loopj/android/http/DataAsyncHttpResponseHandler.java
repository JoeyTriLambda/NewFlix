...
public abstract class DataAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public static byte[] copyOfRange(byte[] bArr, int i10, int i11) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NullPointerException {
        if (i10 > i11) {
        ...
        System.arraycopy(bArr, i10, bArr2, 0, iMin);
        return bArr2;
    }
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    sendProgressDataMessage(copyOfRange(bArr, 0, i10));
    ...
    public void handleMessage(Message message) {
        ...
        try {
            ...
            AsyncHttpClient.log.e(LOG_TAG, "custom onProgressData contains an error", th2);
        }
    }
