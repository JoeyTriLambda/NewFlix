...
public abstract class SaxAsyncHttpResponseHandler<T extends DefaultHandler> extends AsyncHttpResponseHandler {
    ...
    /* JADX WARN: Removed duplicated region for block: B:40:0x0032 A[EXC_TOP_SPLITTER, PHI: r4
  0x0032: PHI (r4v5 java.io.InputStreamReader) = (r4v3 java.io.InputStreamReader), (r4v4 java.io.InputStreamReader), (r4v7 java.io.InputStreamReader) binds: [B:27:0x0053, B:21:0x0046, B:8:0x002f] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    @Override // com.loopj.android.http.AsyncHttpResponseHandler
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public byte[] getResponseData(cz.msebera.android.httpclient.HttpEntity r7) throws java.lang.Throwable {
        /*
            r6 = this;
