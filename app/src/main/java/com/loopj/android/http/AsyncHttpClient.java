...
public class AsyncHttpClient {
    ...
    public static void endEntityViaReflection(HttpEntity httpEntity) {
        ...
        if (httpEntity instanceof HttpEntityWrapper) {
            try {
                ...
                log.e(LOG_TAG, "wrappedEntity consume", th2);
            }
        }
    }
    ...
    public static String getUrlWithQueryString(boolean z10, String str, RequestParams requestParams) {
        ...
        sbR.append(str.contains("?") ? "&" : "?");
        return c.B(sbR.toString(), strTrim);
    }
    ...
    public static boolean isInputStreamGZIPCompressed(PushbackInputStream pushbackInputStream) throws IOException {
        ...
        while (i10 < 2) {
            try {
                int i11 = pushbackInputStream.read(bArr, i10, 2 - i10);
                if (i11 < 0) {
                    return false;
                }
                i10 += i11;
    ...
    public static void silentCloseInputStream(InputStream inputStream) throws IOException {
        if (inputStream != null) {
            try {
                inputStream.close();
            } catch (IOException e10) {
    ...
    public static void silentCloseOutputStream(OutputStream outputStream) throws IOException {
    ...
    public void setEnableRedirects(boolean z10, boolean z11, boolean z12) {
        this.httpClient.getParams().setBooleanParameter(ClientPNames.REJECT_RELATIVE_REDIRECT, !z11);
        this.httpClient.getParams().setBooleanParameter(ClientPNames.ALLOW_CIRCULAR_REDIRECTS, z12);
    ...
    public void setProxy(String str, int i10) {
        this.httpClient.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY, new HttpHost(str, i10));
    }
    ...
    public void setBearerAuth(String str, AuthScope authScope, boolean z10) {
