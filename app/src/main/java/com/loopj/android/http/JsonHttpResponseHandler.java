                        ...
                        JsonHttpResponseHandler.this.postRunnable(new Runnable() { // from class: com.loopj.android.http.JsonHttpResponseHandler.2.1
                            ...
                            public void run() {
                                ...
                                if (obj instanceof JSONObject) {
                                    ...
                                    JsonHttpResponseHandler.this.onFailure(i10, headerArr, new JSONException("Unexpected response type ".concat(response.getClass().getName())), (JSONObject) null);
                                }
                            }
                        });
                        ...
                        JsonHttpResponseHandler.this.postRunnable(new Runnable() { // from class: com.loopj.android.http.JsonHttpResponseHandler.1.1
                            ...
                            public void run() {
                                ...
                                if (obj instanceof JSONArray) {
                                    ...
                                    JsonHttpResponseHandler.this.onFailure(i10, headerArr, (String) response, new JSONException("Response cannot be parsed as JSON data"));
                                } else {
                                    AnonymousClass1 anonymousClass16 = AnonymousClass1.this;
                                    JsonHttpResponseHandler.this.onSuccess(i10, headerArr, (String) response);
                                }
                            }
                        });
                    } catch (JSONException e10) {
