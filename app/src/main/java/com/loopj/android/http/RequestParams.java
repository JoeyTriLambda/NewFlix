...
public class RequestParams implements Serializable {
    ...
    public static class StreamWrapper {
        ...
        public StreamWrapper(InputStream inputStream, String str, String str2, boolean z10) {
        ...
        public static StreamWrapper newInstance(InputStream inputStream, String str, String str2, boolean z10) {
            if (str2 == null) {
                str2 = "application/octet-stream";
            }
            return new StreamWrapper(inputStream, str, str2, z10);
        }
    }
    ...
    private List<BasicNameValuePair> getParamsList(String str, Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                linkedList.addAll(getParamsList(String.format(Locale.US, "%s[%d]", str, Integer.valueOf(i10)), list.get(i10)));
            }
