...
public @interface JsonInclude {
    ...
    public static class Value implements JacksonAnnotationValue<JsonInclude>, Serializable {
        ...
        public String toString() {
            StringBuilder sbQ = c.q(80, "JsonInclude.Value(value=");
            sbQ.append(this._valueInclusion);
            sbQ.append(",content=");
            sbQ.append(this._contentInclusion);
            if (this._valueFilter != null) {
                sbQ.append(",valueFilter=");
                sbQ.append(this._valueFilter.getName());
                sbQ.append(".class");
            }
            if (this._contentFilter != null) {
                sbQ.append(",contentFilter=");
                sbQ.append(this._contentFilter.getName());
                sbQ.append(".class");
            }
            sbQ.append(')');
            return sbQ.toString();
