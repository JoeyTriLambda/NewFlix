...
public abstract class TokenStreamFactory implements Versioned, Serializable {
    ...
    public abstract JsonParser createParser(byte[] bArr, int i10, int i11) throws IOException;

    public abstract JsonParser createParser(char[] cArr) throws IOException;

    public abstract JsonParser createParser(char[] cArr, int i10, int i11) throws IOException;
