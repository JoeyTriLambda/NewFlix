...
public class JsonFactory extends TokenStreamFactory {
    ...
    public IOContext _createContext(Object obj, boolean z10) {
        return new IOContext(_getBufferRecycler(), obj, z10);
    }
    ...
    public JsonGenerator _createUTF8Generator(OutputStream outputStream, IOContext iOContext) throws IOException {
        ...
        int i10 = this._maximumNonEscapedChar;
        if (i10 > 0) {
            uTF8JsonGenerator.setHighestNonEscapedChar(i10);
        }
        CharacterEscapes characterEscapes = this._characterEscapes;
        if (characterEscapes != null) {
    ...
    public JsonParser _createParser(char[] cArr, int i10, int i11, IOContext iOContext, boolean z10) throws IOException {
    ...
    public JsonParser _createParser(byte[] bArr, int i10, int i11, IOContext iOContext) throws IOException {
        return new ByteSourceJsonBootstrapper(iOContext, bArr, i10, i11).constructParser(this._parserFeatures, this._objectCodec, this._byteSymbolCanonicalizer, this._rootCharSymbols, this._factoryFeatures);
    }
    ...
    public JsonFactory(TSFBuilder<?, ?> tSFBuilder, boolean z10) {
        this._rootCharSymbols = CharsToNameCanonicalizer.createRoot();
        this._byteSymbolCanonicalizer = ByteQuadsCanonicalizer.createRoot();
        this._factoryFeatures = DEFAULT_FACTORY_FEATURE_FLAGS;
        this._parserFeatures = DEFAULT_PARSER_FEATURE_FLAGS;
