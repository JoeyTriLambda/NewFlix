...
public class AnnotationIntrospectorPair extends AnnotationIntrospector {
    ...
    public String findEnumValue(Enum<?> r22) {
        String strFindEnumValue = this._primary.findEnumValue(r22);
        return strFindEnumValue == null ? this._secondary.findEnumValue(r22) : strFindEnumValue;
    }
    ...
    public String[] findPropertiesToIgnore(Annotated annotated, boolean z10) {
        String[] strArrFindPropertiesToIgnore = this._primary.findPropertiesToIgnore(annotated, z10);
        return strArrFindPropertiesToIgnore == null ? this._secondary.findPropertiesToIgnore(annotated, z10) : strArrFindPropertiesToIgnore;
    }
}
