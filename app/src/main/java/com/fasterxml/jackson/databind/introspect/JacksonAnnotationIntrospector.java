...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector {
    ...
    public void findAndAddVirtualProperties(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass, List<BeanPropertyWriter> list) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            BeanPropertyWriter beanPropertyWriter_constructVirtualProperty = _constructVirtualProperty(attrArrAttrs[i10], mapperConfig, annotatedClass, javaTypeConstructType);
            if (zPrepend) {
                list.add(i10, beanPropertyWriter_constructVirtualProperty);
            } else {
        ...
        for (int i11 = 0; i11 < length2; i11++) {
            BeanPropertyWriter beanPropertyWriter_constructVirtualProperty2 = _constructVirtualProperty(propArrProps[i11], mapperConfig, annotatedClass);
            if (zPrepend) {
                list.add(i11, beanPropertyWriter_constructVirtualProperty2);
            } else {
    ...
    @Override // com.fasterxml.jackson.databind.AnnotationIntrospector
    @Deprecated
    public String findEnumValue(Enum<?> r32) throws NoSuchFieldException {
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (cls_classIfExplicit != null && !javaType.hasRawClass(cls_classIfExplicit) && !_primitiveAndWrapper(javaType, cls_classIfExplicit)) {
            try {
                ...
                throw new JsonMappingException((Closeable) null, String.format("Failed to narrow type %s with annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit.getName(), annotated.getName(), e10.getMessage()), e10);
            }
        }
        if (javaType.isMapLikeType()) {
            ...
            if (cls_classIfExplicit2 != null && !_primitiveAndWrapper(keyType, cls_classIfExplicit2)) {
                try {
                    ...
                    throw new JsonMappingException((Closeable) null, String.format("Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit2.getName(), annotated.getName(), e11.getMessage()), e11);
                }
            }
        }
        ...
        try {
            ...
            throw new JsonMappingException((Closeable) null, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit3.getName(), annotated.getName(), e12.getMessage()), e12);
        }
    }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (cls_classIfExplicit != null) {
            if (javaType.hasRawClass(cls_classIfExplicit)) {
                ...
                try {
                    ...
                    throw new JsonMappingException((Closeable) null, String.format("Failed to widen type %s with annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit.getName(), annotated.getName(), e10.getMessage()), e10);
                }
            }
        }
        if (javaType.isMapLikeType()) {
            ...
            if (cls_classIfExplicit2 != null) {
                if (keyType.hasRawClass(cls_classIfExplicit2)) {
                    ...
                    try {
                        ...
                        throw new JsonMappingException((Closeable) null, String.format("Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit2.getName(), annotated.getName(), e11.getMessage()), e11);
                    }
                }
        ...
        if (contentType.hasRawClass(cls_classIfExplicit3)) {
            ...
            try {
                ...
                throw new JsonMappingException((Closeable) null, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit3.getName(), annotated.getName(), e12.getMessage()), e12);
            }
        }
