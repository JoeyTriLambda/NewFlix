...
public class BeanPropertyWriter extends PropertyWriter {
    ...
    public String toString() {
        StringBuilder sbQ = c.q(40, "property '");
        sbQ.append(getName());
        sbQ.append("' (");
        if (this._accessorMethod != null) {
            sbQ.append("via method ");
            sbQ.append(this._accessorMethod.getDeclaringClass().getName());
            sbQ.append("#");
            sbQ.append(this._accessorMethod.getName());
        } else if (this._field != null) {
            sbQ.append("field \"");
            sbQ.append(this._field.getDeclaringClass().getName());
            sbQ.append("#");
            sbQ.append(this._field.getName());
        } else {
            sbQ.append("virtual");
        }
        ...
        if (jsonSerializer == null) {
            ...
            sbQ.append(", static serializer of type ".concat(jsonSerializer.getClass().getName()));
        }
        sbQ.append(')');
        return sbQ.toString();
    }
