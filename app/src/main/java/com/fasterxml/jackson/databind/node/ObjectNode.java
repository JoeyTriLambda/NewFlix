...
public class ObjectNode extends ContainerNode<ObjectNode> {
    ...
    public ObjectNode with(String str) {
        ...
        StringBuilder sbV = c.v("Property '", str, "' has value that is not of type ObjectNode (but ");
        sbV.append(jsonNode.getClass().getName());
        sbV.append(")");
    ...
    public ArrayNode withArray(String str) {
        ...
        StringBuilder sbV = c.v("Property '", str, "' has value that is not of type ArrayNode (but ");
        sbV.append(jsonNode.getClass().getName());
        sbV.append(")");
        throw new UnsupportedOperationException(sbV.toString());
    }
    ...
    public ObjectNode put(String str, Short sh2) {
        ...
        if (sh2 == null) {
            ...
            jsonNodeNumberNode = numberNode(sh2.shortValue());
        }
    ...
    public ObjectNode put(String str, Long l10) {
        ...
        if (l10 == null) {
            ...
            jsonNodeNumberNode = numberNode(l10.longValue());
        }
        return _put(str, jsonNodeNumberNode);
    }
    ...
    public ObjectNode put(String str, Float f10) {
        ...
        if (f10 == null) {
            ...
            jsonNodeNumberNode = numberNode(f10.floatValue());
        }
        return _put(str, jsonNodeNumberNode);
    }
    ...
    public ObjectNode put(String str, Double d10) {
        ...
        if (d10 == null) {
            ...
            jsonNodeNumberNode = numberNode(d10.doubleValue());
        }
        return _put(str, jsonNodeNumberNode);
    }
