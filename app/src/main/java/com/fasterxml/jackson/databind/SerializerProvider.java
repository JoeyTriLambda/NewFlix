...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public void defaultSerializeDateKey(long j10, JsonGenerator jsonGenerator) throws IOException {
        if (isEnabled(SerializationFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS)) {
            ...
            jsonGenerator.writeFieldName(_dateFormat().format(new Date(j10)));
        }
    }
    ...
    public final void defaultSerializeDateValue(long j10, JsonGenerator jsonGenerator) throws IOException {
        if (isEnabled(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS)) {
            ...
            jsonGenerator.writeString(_dateFormat().format(new Date(j10)));
        }
    }
    ...
    public JsonSerializer<Object> findTypedValueSerializer(Class<?> cls, boolean z10, BeanProperty beanProperty) throws JsonMappingException {
    ...
    public <T> T reportBadDefinition(JavaType javaType, String str, Throwable th2) throws JsonMappingException {
        ...
        invalidDefinitionExceptionFrom.initCause(th2);
    ...
    public JsonSerializer<Object> findTypedValueSerializer(JavaType javaType, boolean z10, BeanProperty beanProperty) throws JsonMappingException {
