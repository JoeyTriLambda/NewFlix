...
public final class ClassUtil {
    ...
    public static <T> T createInstance(Class<T> cls, boolean z10) throws NoSuchMethodException, SecurityException, IllegalArgumentException {
        ...
        if (constructorFindConstructor == null) {
            throw new IllegalArgumentException(c.d(cls, new StringBuilder("Class "), " has no default (no arg) constructor"));
        }
        try {
    ...
    public static Object defaultValue(Class<?> cls) {
        ...
        throw new IllegalArgumentException(c.d(cls, new StringBuilder("Class "), " is not a primitive type"));
    }
    ...
    public static String exceptionMessage(Throwable th2) {
        return th2 instanceof JsonProcessingException ? ((JsonProcessingException) th2).getOriginalMessage() : th2.getMessage();
    }
    ...
    public static void checkAndFixAccess(Member member, boolean z10) throws SecurityException {
