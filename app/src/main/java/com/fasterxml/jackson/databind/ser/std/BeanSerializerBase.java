...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        ObjectIdWriter objectIdWriterConstruct;
        ...
        if (valueFindFormatOverrides == null || !valueFindFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (ClassUtil.isEnumType(this._handledType)) {
                    int i11 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[shape.ordinal()];
        ...
        ObjectIdWriter objectIdWriterWithAlwaysAsId = this._objectIdWriter;
        if (member != null) {
            ...
            if (objectIdInfoFindObjectIdInfo == null) {
                if (objectIdWriterWithAlwaysAsId != null && (objectIdInfoFindObjectReferenceInfo = annotationIntrospector.findObjectReferenceInfo(member, null)) != null) {
                    objectIdWriterWithAlwaysAsId = this._objectIdWriter.withAlwaysAsId(objectIdInfoFindObjectReferenceInfo.getAlwaysAsId());
                }
                obj = null;
            } else {
                ...
                if (generatorType == ObjectIdGenerators.PropertyGenerator.class) {
                    ...
                    while (true) {
                        ...
                        beanPropertyWriter = this._props[i12];
                    ...
                    if (i12 > 0) {
                        ...
                        System.arraycopy(beanPropertyWriterArr, 0, beanPropertyWriterArr, 1, i12);
                        this._props[0] = beanPropertyWriter;
                        BeanPropertyWriter[] beanPropertyWriterArr2 = this._filteredProps;
                        if (beanPropertyWriterArr2 != null) {
                            BeanPropertyWriter beanPropertyWriter2 = beanPropertyWriterArr2[i12];
                            System.arraycopy(beanPropertyWriterArr2, 0, beanPropertyWriterArr2, 1, i12);
                ...
                objectIdWriterWithAlwaysAsId = objectIdWriterConstruct;
            }
        ...
        BeanSerializerBase beanSerializerBaseWithObjectIdWriter = (objectIdWriterWithAlwaysAsId == null || (objectIdWriterWithSerializer = objectIdWriterWithAlwaysAsId.withSerializer(serializerProvider.findValueSerializer(objectIdWriterWithAlwaysAsId.idType, beanProperty))) == this._objectIdWriter) ? this : withObjectIdWriter(objectIdWriterWithSerializer);
