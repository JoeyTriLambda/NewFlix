...
public final class AnnotatedParameter extends AnnotatedMember {
    ...
    public AnnotatedParameter(AnnotatedWithParams annotatedWithParams, JavaType javaType, TypeResolutionContext typeResolutionContext, AnnotationMap annotationMap, int i10) {
