...
public class BeanDeserializerFactory extends BasicDeserializerFactory {
    ...
    */
    ...
    public void addInjectables(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws SecurityException, JsonMappingException {
    ...
    public SettableAnyProperty constructAnySetter(DeserializationContext deserializationContext, BeanDescription beanDescription, AnnotatedMember annotatedMember) throws JsonMappingException {
        ...
        ?? r22 = keyDeserializerFindKeyDeserializerFromAnnotation;
        if (keyDeserializerFindKeyDeserializerFromAnnotation == null) {
            r22 = (KeyDeserializer) keyType.getValueHandler();
        }
        if (r22 == 0) {
            keyDeserializerCreateContextual = deserializationContext.findKeyDeserializer(keyType, std);
        } else {
            boolean z10 = r22 instanceof ContextualKeyDeserializer;
            keyDeserializerCreateContextual = r22;
            if (z10) {
                keyDeserializerCreateContextual = ((ContextualKeyDeserializer) r22).createContextual(deserializationContext, std);
            }
        }
    ...
    public boolean isPotentialBeanType(Class<?> cls) {
        ...
        if (ClassUtil.isProxyType(cls)) {
            throw new IllegalArgumentException(c.d(cls, new StringBuilder("Cannot deserialize Proxy class "), " as a Bean"));
        }
