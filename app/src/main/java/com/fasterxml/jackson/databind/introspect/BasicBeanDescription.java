...
public class BasicBeanDescription extends BeanDescription {
        ...
        for (BeanPropertyDefinition beanPropertyDefinition : _properties()) {
            ...
            if (referencePropertyFindReferenceType != null && referencePropertyFindReferenceType.isBackReference()) {
                ...
                if (arrayList == null) {
                    ...
                    throw new IllegalArgumentException(c.k("Multiple back-reference properties with name '", name, "'"));
                }
    ...
    @Override // com.fasterxml.jackson.databind.BeanDescription
    public Object instantiateBean(boolean z10) throws SecurityException {
