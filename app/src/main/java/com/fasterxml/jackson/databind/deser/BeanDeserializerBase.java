...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, ValueInstantiator.Gettable {
    ...
    public BeanDeserializerBase(BeanDeserializerBuilder beanDeserializerBuilder, BeanDescription beanDescription, BeanPropertyMap beanPropertyMap, Map<String, SettableBeanProperty> map, Set<String> set, boolean z10, boolean z11) {
        ...
        if (!this._nonStandardCreation && valueInjectorArr == null && !z11 && objectIdReader == null) {
            z12 = true;
        }
    ...
    public void resolve(DeserializationContext deserializationContext) throws SecurityException, JsonMappingException {
        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            ...
            if (this._ignorableProps != null) {
                ...
                for (int i10 = 0; i10 < length; i10++) {
                    if (this._ignorableProps.contains(fromObjectArguments[i10].getName())) {
                        fromObjectArguments[i10].markAsIgnorable();
                    }
                }
            }
        } else {
