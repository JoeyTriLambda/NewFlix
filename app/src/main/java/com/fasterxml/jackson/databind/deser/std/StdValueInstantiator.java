    ...
    */
    ...
    public Object createFromBoolean(DeserializationContext deserializationContext, boolean z10) throws IOException {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._fromBooleanCreator.getDeclaringClass(), boolValueOf, rewrapCtorProblem(deserializationContext, th2));
        }
    }
    ...
    public Object createFromDouble(DeserializationContext deserializationContext, double d10) throws IOException {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._fromDoubleCreator.getDeclaringClass(), dValueOf, rewrapCtorProblem(deserializationContext, th2));
        }
    }
    ...
    public Object createFromInt(DeserializationContext deserializationContext, int i10) throws IOException {
        if (this._fromIntCreator != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._fromIntCreator.getDeclaringClass(), numValueOf, rewrapCtorProblem(deserializationContext, th2));
            }
        }
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._fromLongCreator.getDeclaringClass(), lValueOf, rewrapCtorProblem(deserializationContext, th3));
        }
    }
    ...
    public JsonMappingException wrapException(Throwable th2) {
        ...
        return new JsonMappingException((Closeable) null, "Instantiation of " + getValueTypeDesc() + " value failed: " + ClassUtil.exceptionMessage(th2), th2);
    }
