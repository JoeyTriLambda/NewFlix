...
public class AsyncRequestQueue extends RequestQueue {
    ...
    public static class Builder {
        ...
        private ExecutorFactory getDefaultExecutorFactory() {
            return new ExecutorFactory() { // from class: com.android.volley.AsyncRequestQueue.Builder.1
                private ThreadPoolExecutor getNewThreadPoolExecutor(int i10, String str, BlockingQueue<Runnable> blockingQueue) {
                    return new ThreadPoolExecutor(0, i10, 60L, TimeUnit.SECONDS, blockingQueue, getThreadFactory(str));
                }
    ...
    public class CacheParseTask<T> extends RequestTask<T> {
        ...
        public CacheParseTask(Request<T> request, Cache.Entry entry, long j10) {
            super(request);
            this.entry = entry;
    ...
    public void finishRequest(Request<?> request, Response<?> response, boolean z10) {
        if (z10) {
