...
final class zzwj {
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        zzwi zzwiVar = zzf;
        long j11 = (-4) & j10;
        int i10 = zzwiVar.zza.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        zzwiVar.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzwiVar.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzwiVar.zza.getInt(obj, j11) & (~(255 << i10))));
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th2) {
        Logger.getLogger(zzwj.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
    }
