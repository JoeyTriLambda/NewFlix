...
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zae {
    ...
    public final ClientSettings f8643b;
    ...
    public SignInClientImpl(Context context, Looper looper, boolean z10, ClientSettings clientSettings, Bundle bundle, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        this.f8642a = true;
        this.f8643b = clientSettings;
        this.f8644c = bundle;
        this.f8645d = clientSettings.zab();
    }
    ...
    public final void zaa() {
        try {
            ((zaf) getService()).zae(((Integer) Preconditions.checkNotNull(this.f8645d)).intValue());
    ...
    public final void zac(IAccountAccessor iAccountAccessor, boolean z10) {
        try {
            ((zaf) getService()).zaf(iAccountAccessor, ((Integer) Preconditions.checkNotNull(this.f8645d)).intValue(), z10);
        } catch (RemoteException unused) {
    ...
    public final void zad(zae zaeVar) {
        ...
        try {
            Account accountOrDefault = this.f8643b.getAccountOrDefault();
            ((zaf) getService()).zag(new zai(1, new zat(accountOrDefault, ((Integer) Preconditions.checkNotNull(this.f8645d)).intValue(), BaseGmsClient.DEFAULT_ACCOUNT.equals(accountOrDefault.name) ? Storage.getInstance(getContext()).getSavedDefaultGoogleSignInAccount() : null)), zaeVar);
