        ...
        switch (zzbs.zza[zzg.zza(str).ordinal()]) {
            ...
            case 2:
                ...
                for (int i11 = 0; i11 < list.size() - 1; i11 += 2) {
                    ...
                    zzhVar.zzb(zzaqVarZza3.zzf(), zzhVar.zza(list.get(i11 + 1)));
                }
                return zzaq.zzc;
            case 3:
                if (list.isEmpty()) {
            ...
            case 4:
                ...
                while (i10 < list.size() - 1) {
                    zzaq zzaqVarZza5 = zzhVar.zza(list.get(i10));
                    zzaq zzaqVarZza6 = zzhVar.zza(list.get(i10 + 1));
            ...
            case 5:
                ...
                while (i10 < list.size()) {
                    zzaqVarZza7 = zzhVar.zza(list.get(i10));
