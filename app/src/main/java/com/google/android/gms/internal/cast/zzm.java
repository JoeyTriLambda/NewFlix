...
public final class zzm {
    ...
    private static void zzi(zznn zznnVar, boolean z10) {
    ...
    public final zzno zzb(zzl zzlVar, boolean z10) {
    ...
    */
    ...
    public final zzno zzf(zzl zzlVar, int i10, int i11) {
        zznn zznnVarZzh = zzh(zzlVar);
        zznf zznfVarZzc = zzng.zzc(zznnVarZzh.zza());
        zznfVarZzc.zzj(i10);
        zznfVarZzc.zzi(i11);
    ...
    public final zzno zzg(zzl zzlVar, int i10) {
        zznn zznnVarZzh = zzh(zzlVar);
        zznf zznfVarZzc = zzng.zzc(zznnVarZzh.zza());
        zznfVarZzc.zzj(i10);
        zznnVarZzh.zze((zzng) zznfVarZzc.zzq());
