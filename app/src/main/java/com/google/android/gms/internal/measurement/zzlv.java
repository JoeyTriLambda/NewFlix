...
interface zzlv {
    ...
    <T> void zza(T t10, zzly<T> zzlyVar, zzjg zzjgVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzly<T> zzlyVar, zzjg zzjgVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzkx<K, V> zzkxVar, zzjg zzjgVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t10, zzly<T> zzlyVar, zzjg zzjgVar) throws IOException;

    void zzb(List<zzij> list) throws IOException;

    <T> void zzb(List<T> list, zzly<T> zzlyVar, zzjg zzjgVar) throws IOException;
