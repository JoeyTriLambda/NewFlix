...
public final class zzk {
    ...
    public static /* bridge */ /* synthetic */ void zzm(zzk zzkVar, int i10) {
        zza.d("log session ended with error = %d", Integer.valueOf(i10));
        zzkVar.zzs();
        zzkVar.zzb.zze(zzkVar.zzd.zze(zzkVar.zzh, i10), 228);
        zzkVar.zzr();
        if (zzkVar.zzj) {
            return;
        }
