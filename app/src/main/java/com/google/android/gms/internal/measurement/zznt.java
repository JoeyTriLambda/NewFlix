...
interface zznt {
    ...
    void zza(int i10, zzij zzijVar) throws IOException;

    <K, V> void zza(int i10, zzkx<K, V> zzkxVar, Map<K, V> map) throws IOException;

    void zza(int i10, Object obj) throws IOException;

    @Deprecated
    void zza(int i10, Object obj, zzly zzlyVar) throws IOException;

    void zza(int i10, String str) throws IOException;

    void zza(int i10, List<zzij> list) throws IOException;

    @Deprecated
    void zza(int i10, List<?> list, zzly zzlyVar) throws IOException;
    ...
    void zzb(int i10, Object obj, zzly zzlyVar) throws IOException;

    void zzb(int i10, List<String> list) throws IOException;

    void zzb(int i10, List<?> list, zzly zzlyVar) throws IOException;
