...
public final class CastUtils {
    ...
    public static final Pattern f6800a = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");

    /* renamed from: b, reason: collision with root package name */
    public static final Random f6801b = new Random(SystemClock.elapsedRealtime());
