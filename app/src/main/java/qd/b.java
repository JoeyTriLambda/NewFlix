...
public final class b extends BaseProcessor {
    ...
    public void process() {
        ...
        new a(this, ac.c.p(new StringBuilder(), this.f12433d, "/search/", BaseProcessor.removeSpecialCharsOld(movie.getTitle()).replace(StringUtils.SPACE, "%20"))).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
    }
}
