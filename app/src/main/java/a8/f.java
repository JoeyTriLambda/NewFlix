...
public final class f {
    public static Map<String, String> a(Locale locale) {
        HashMap mapX = ac.c.x("error_initializing_player", "An error occurred while initializing the YouTube player.", "get_youtube_app_title", "Get YouTube App");
        mapX.put("get_youtube_app_text", "This app won't run without the YouTube App, which is missing from your device");
        mapX.put("get_youtube_app_action", "Get YouTube App");
        mapX.put("enable_youtube_app_title", "Enable YouTube App");
        mapX.put("enable_youtube_app_text", "This app won't work unless you enable the YouTube App.");
        mapX.put("enable_youtube_app_action", "Enable YouTube App");
        mapX.put("update_youtube_app_title", "Update YouTube App");
        mapX.put("update_youtube_app_text", "This app won't work unless you update the YouTube App.");
        mapX.put("update_youtube_app_action", "Update YouTube App");
        b(locale.getLanguage(), mapX);
