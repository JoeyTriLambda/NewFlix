...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i10, Bundle bundle) {
            ...
            StringBuilder sbS = c.s("Unknown result code: ", i10, " (extras=");
            sbS.append(this.mExtras);
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            try {
                ...
                IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(i.getBinder(extras, "extra_session_binder"));
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbU = c.u(str, " for ");
                sbU.append(MediaBrowserImplBase.this.mServiceComponent);
                sbU.append(" with mServiceConnection=");
                sbU.append(MediaBrowserImplBase.this.mServiceConnection);
                sbU.append(" this=");
                sbU.append(this);
                Log.i(MediaBrowserCompat.TAG, sbU.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i10) {
            return i10 != 0 ? i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? c.f("UNKNOWN/", i10) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbU = c.u(str, " for ");
            sbU.append(this.mServiceComponent);
            sbU.append(" with mCallbacksMessenger=");
            sbU.append(this.mCallbacksMessenger);
            sbU.append(" this=");
            sbU.append(this);
            Log.i(MediaBrowserCompat.TAG, sbU.toString());
            return false;
        ...
        public void connect() {
            int i10 = this.mState;
            if (i10 != 0 && i10 != 1) {
                throw new IllegalStateException(c.o(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(c.o(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(c.o(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(c.m(new StringBuilder("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(c.m(new StringBuilder("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(c.o(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e10) {
    ...
    public static class ServiceBinderWrapper {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            i.putBinder(bundle2, "data_callback_token", iBinder);
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            i.putBinder(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i10 = 0; i10 < this.mOptionsList.size(); i10++) {
                if (x1.a.areSameOptions(this.mOptionsList.get(i10), bundle)) {
