...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((x1.b) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new x1.b(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        i.putBinder(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
                        s2.a.putVersionedParcelable(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            x1.b currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(x1.b bVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, c cVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, c cVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, cVar, bundle);
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, c cVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, c cVar, Bundle bundle) {
            super(context, str, cVar, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final x1.b getCurrentControllerInfo() {
            return new x1.b(this.mSessionFwk.getCurrentControllerInfo());
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(x1.b bVar) {
        }
    }

    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, c cVar, Bundle bundle) {
            super(context, str, cVar, bundle);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(i.getBinder(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            c versionedParcelable = s2.a.getVersionedParcelable(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (iMediaSession != null) {
                    i.putBinder(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                }
                c cVar = this.mSession2Token;
                if (cVar != null) {
                    s2.a.putVersionedParcelable(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, cVar);
                }
            }
            return bundle;
        }
    ...
    public void setPlaybackToRemote(f fVar) {
        ...
        this.mImpl.setPlaybackToRemote(fVar);
    }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, c cVar) {
        this.mActiveListeners = new ArrayList<>();
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = z1.a.getMediaButtonReceiverComponent(context)) == null) {
                ...
                int i10 = Build.VERSION.SDK_INT;
                if (i10 >= 29) {
                    this.mImpl = new MediaSessionImplApi29(context, str, cVar, bundle);
                } else if (i10 >= 28) {
                    this.mImpl = new MediaSessionImplApi28(context, str, cVar, bundle);
                } else if (i10 >= 22) {
                    this.mImpl = new MediaSessionImplApi22(context, str, cVar, bundle);
                } else {
                    this.mImpl = new MediaSessionImplApi21(context, str, cVar, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public MediaSessionImplApi21(Context context, String str, c cVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionCreateFwkMediaSession.getSessionToken(), extraSession, cVar);
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public x1.b getCurrentControllerInfo() {
            x1.b bVar;
            synchronized (this.mLock) {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(f fVar) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) fVar.getVolumeProvider());
        }
        ...
        public static class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                mediaSessionImplApi21.mExtraControllerCallbacks.register(iMediaControllerCallback, new x1.b("android.media.session.MediaController", callingPid, callingUid));
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private f.d mVolumeCallback = new f.d() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // x1.f.d
            public void onVolumeChanged(f fVar) {
                ...
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, fVar.getVolumeControl(), fVar.getMaxVolume(), fVar.getCurrentVolume()));
            }
        };
        ...
        public static class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i10) {
                postToHandler(26, mediaDescriptionCompat, i10, null);
            }
            ...
            public void adjustVolume(int i10, int i11, String str) {
                ...
                if (mediaSessionImplBase != null) {
                    mediaSessionImplBase.adjustVolume(i10, i11);
                }
            }
            ...
            public long getFlags() {
                ...
                synchronized (mediaSessionImplBase.mLock) {
                    j10 = mediaSessionImplBase.mFlags;
                }
                return j10;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (mediaSessionImplBase.mLock) {
                    int i11 = mediaSessionImplBase.mVolumeType;
                    int i12 = mediaSessionImplBase.mLocalStream;
                    f fVar = mediaSessionImplBase.mVolumeProvider;
                    int i13 = 2;
                    if (i11 == 2) {
                        int volumeControl = fVar.getVolumeControl();
                        int maxVolume = fVar.getMaxVolume();
                        streamVolume = fVar.getCurrentVolume();
                        i10 = maxVolume;
                        i13 = volumeControl;
                    } else {
                        int streamMaxVolume = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i12);
                        streamVolume = mediaSessionImplBase.mAudioManager.getStreamVolume(i12);
                        i10 = streamMaxVolume;
                    }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                int callingPid = Binder.getCallingPid();
                int callingUid = Binder.getCallingUid();
                mediaSessionImplBase.mControllerCallbacks.register(iMediaControllerCallback, new x1.b(mediaSessionImplBase.getPackageNameForUid(callingUid), callingPid, callingUid));
                synchronized (mediaSessionImplBase.mLock) {
            ...
            public void setVolumeTo(int i10, int i11, String str) {
                MediaSessionImplBase mediaSessionImplBase = this.mMediaSessionImplRef.get();
                if (mediaSessionImplBase != null) {
                    mediaSessionImplBase.setVolumeTo(i10, i11);
                }
            }
            ...
            public void postToHandler(int i10, int i11) {
                postToHandler(i10, null, i11, null);
            }

            public void postToHandler(int i10, Object obj) {
                postToHandler(i10, obj, 0, null);
            }

            public void postToHandler(int i10, Object obj, Bundle bundle) {
                postToHandler(i10, obj, 0, bundle);
            }

            public void postToHandler(int i10, Object obj, int i11, Bundle bundle) {
                MediaSessionImplBase mediaSessionImplBase = this.mMediaSessionImplRef.get();
                if (mediaSessionImplBase != null) {
                    mediaSessionImplBase.postToHandler(i10, i11, 0, obj, bundle);
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new x1.b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, c cVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionStub, null, cVar);
            this.mRatingType = 0;
            this.mVolumeType = 1;
            this.mLocalStream = 3;
        ...
        public void adjustVolume(int i10, int i11) {
            ...
            f fVar = this.mVolumeProvider;
            if (fVar != null) {
                fVar.onAdjustVolume(i10);
            }
        }
        ...
        public void setPlaybackToRemote(f fVar) {
            ...
            f fVar2 = this.mVolumeProvider;
            if (fVar2 != null) {
                fVar2.setCallback(null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = fVar;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.getVolumeControl(), this.mVolumeProvider.getMaxVolume(), this.mVolumeProvider.getCurrentVolume()));
            fVar.setCallback(this.mVolumeCallback);
        }
