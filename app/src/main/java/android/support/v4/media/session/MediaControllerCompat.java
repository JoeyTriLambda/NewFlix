...
public final class MediaControllerCompat {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i10, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(i.getBinder(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(s2.a.getVersionedParcelable(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i10, int i11, int i12, int i13, int i14) {
            this(i10, new AudioAttributesCompat.a().setLegacyStreamType(i11).build(), i12, i13, i14);
        }
