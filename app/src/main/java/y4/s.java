...
public final class s extends SQLiteOpenHelper {
    ...
    public static final String f21902n = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")";

    /* renamed from: o, reason: collision with root package name */
    public static final int f21903o = 5;

    /* renamed from: p, reason: collision with root package name */
    public static final List<a> f21904p;
    ...
    static {
        ...
        final int i13 = 3;
        final int i14 = 4;
        f21904p = Arrays.asList(new a() { // from class: y4.r
            @Override // y4.s.a
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                switch (i10) {
                    ...
                    default:
                        ...
                        sQLiteDatabase.execSQL(s.f21902n);
                        break;
                }
            }
        }, new a() { // from class: y4.r
            @Override // y4.s.a
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                switch (i11) {
                    case 0:
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        ...
        if (i11 <= list.size()) {
            ...
            StringBuilder sbT = ac.c.t("Migration from ", i10, " to ", i11, " was requested, but cannot be performed. Only ");
            sbT.append(list.size());
            sbT.append(" migrations are provided");
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        a(sQLiteDatabase, 0, this.f21905b);
    }
