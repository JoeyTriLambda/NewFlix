...
public class DefaultRequestDirector implements RequestDirector {
    ...
    public boolean createTunnelToTarget(HttpRoute httpRoute, HttpContext httpContext) throws IOException, HttpException {
    ...
    public void establishRoute(HttpRoute httpRoute, HttpContext httpContext) throws IOException, HttpException {
        int iNextStep;
        ...
        do {
            ...
            switch (iNextStep) {
                ...
                case 5:
                    ...
                    break;
                default:
                    throw new IllegalStateException(a.d("Unknown step indicator ", iNextStep, " from RouteDirector."));
            }
        } while (iNextStep > 0);
    }
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        while (!z10) {
            try {
                ...
                } catch (TunnelRefusedException e10) {
                    if (this.log.isDebugEnabled()) {
                        this.log.debug(e10.getMessage());
                    }
    ...
    public RoutedRequest handleResponse(RoutedRequest routedRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (i10 >= this.maxRedirects) {
            throw new RedirectException(c.m(new StringBuilder("Maximum redirects ("), this.maxRedirects, ") exceeded"));
        }
