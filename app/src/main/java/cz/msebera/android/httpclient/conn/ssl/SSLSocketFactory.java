...
public class SSLSocketFactory implements LayeredConnectionSocketFactory, SchemeLayeredSocketFactory, LayeredSchemeSocketFactory, LayeredSocketFactory {
    ...
    public Socket createLayeredSocket(Socket socket, String str, int i10, boolean z10) throws IOException {
        return createLayeredSocket(socket, str, i10, (HttpContext) null);
    }
    ...
    public Socket connectSocket(Socket socket, String str, int i10, InetAddress inetAddress, int i11, HttpParams httpParams) throws IOException {
        ...
        return connectSocket(socket, new HttpInetSocketAddress(new HttpHost(str, i10), byName, i10), inetSocketAddress, httpParams);
    }
