...
class InternalHttpClient extends CloseableHttpClient implements Configurable {
    ...
    public CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
    ...
    public ClientConnectionManager getConnectionManager() {
        return new ClientConnectionManager() { // from class: cz.msebera.android.httpclient.impl.client.InternalHttpClient.1
            ...
            public void closeIdleConnections(long j10, TimeUnit timeUnit) {
                InternalHttpClient.this.connManager.closeIdleConnections(j10, timeUnit);
            }
