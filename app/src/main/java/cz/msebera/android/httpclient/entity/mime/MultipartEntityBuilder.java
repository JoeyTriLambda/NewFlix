...
public class MultipartEntityBuilder {
    ...
    public MultipartFormEntity buildEntity() {
        ...
        ContentType contentTypeWithParameters = contentType3 != null ? contentType3.withParameters(nameValuePairArr) : ContentType.create("multipart/form-data", nameValuePairArr);
        ...
        int i10 = AnonymousClass1.$SwitchMap$cz$msebera$android$httpclient$entity$mime$HttpMultipartMode[httpMultipartMode.ordinal()];
        AbstractMultipartForm httpStrictMultipart = i10 != 1 ? i10 != 2 ? new HttpStrictMultipart(charset, strGenerateBoundary, arrayList2) : new HttpRFC6532Multipart(charset, strGenerateBoundary, arrayList2) : new HttpBrowserCompatibleMultipart(charset, strGenerateBoundary, arrayList2);
        return new MultipartFormEntity(httpStrictMultipart, contentTypeWithParameters, httpStrictMultipart.getTotalLength());
    }
