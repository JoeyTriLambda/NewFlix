...
public class ServiceUnavailableRetryExec implements ClientExecChain {
    ...
    public CloseableHttpResponse execute(HttpRoute httpRoute, HttpRequestWrapper httpRequestWrapper, HttpClientContext httpClientContext, HttpExecutionAware httpExecutionAware) throws InterruptedException, IOException, HttpException {
        ...
        while (true) {
            ...
            try {
                if (!this.retryStrategy.retryRequest(closeableHttpResponseExecute, i10, httpClientContext) || !RequestEntityProxy.isRepeatable(httpRequestWrapper)) {
                    break;
                }
