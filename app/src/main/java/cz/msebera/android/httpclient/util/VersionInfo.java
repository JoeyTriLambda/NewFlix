...
public class VersionInfo {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder(this.infoClassloader.length() + this.infoTimestamp.length() + this.infoRelease.length() + this.infoModule.length() + this.infoPackage.length() + 20);
    ...
    public static VersionInfo loadVersionInfo(String str, ClassLoader classLoader) throws IOException {
        ...
        try {
            resourceAsStream = classLoader.getResourceAsStream(str.replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, JsonPointer.SEPARATOR) + "/version.properties");
