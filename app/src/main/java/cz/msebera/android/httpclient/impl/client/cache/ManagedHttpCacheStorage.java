...
public class ManagedHttpCacheStorage implements HttpCacheStorage, Closeable {
    ...
    public HttpCacheEntry getEntry(String str) throws IllegalStateException, IOException {
    ...
    @Override // cz.msebera.android.httpclient.client.cache.HttpCacheStorage
    public void putEntry(String str, HttpCacheEntry httpCacheEntry) throws IllegalStateException, IOException {
        Args.notNull(str, "URL");
    ...
    @Override // cz.msebera.android.httpclient.client.cache.HttpCacheStorage
    public void removeEntry(String str) throws IllegalStateException, IOException {
        Args.notNull(str, "URL");
        ensureValidState();
        synchronized (this) {
    ...
    @Override // cz.msebera.android.httpclient.client.cache.HttpCacheStorage
    public void updateEntry(String str, HttpCacheUpdateCallback httpCacheUpdateCallback) throws IllegalStateException, IOException {
        Args.notNull(str, "URL");
