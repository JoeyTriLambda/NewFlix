    ...
    public void validate(Cookie cookie, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        if (host.contains(".")) {
            ...
            if (isSpecialDomain(domain)) {
                if (iCountTokens < 2) {
                    throw new CookieRestrictionViolationException(c.k("Domain attribute \"", domain, "\" violates the Netscape cookie specification for special domains"));
                }
            } else if (iCountTokens < 3) {
                throw new CookieRestrictionViolationException(c.k("Domain attribute \"", domain, "\" violates the Netscape cookie specification"));
            }
        }
    }
}
