...
public class ConnectionConfig implements Cloneable {
    ...
    public static class Builder {
        ...
        public ConnectionConfig build() {
            ...
            int i12 = this.fragmentSizeHint;
            return new ConnectionConfig(i11, i12 >= 0 ? i12 : i11, charset2, this.malformedInputAction, this.unmappableInputAction, this.messageConstraints);
        }
    ...
    public ConnectionConfig m26clone() throws CloneNotSupportedException {
