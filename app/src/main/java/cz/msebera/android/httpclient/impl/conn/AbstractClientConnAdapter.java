...
public abstract class AbstractClientConnAdapter implements ManagedClientConnection, HttpContext {
    ...
    @Override // cz.msebera.android.httpclient.HttpClientConnection
    public boolean isResponseAvailable(int i10) throws IOException, ConnectionShutdownException {
        OperatedClientConnection wrappedConnection = getWrappedConnection();
        assertValid(wrappedConnection);
    ...
    @Override // cz.msebera.android.httpclient.HttpConnection
    public void setSocketTimeout(int i10) throws ConnectionShutdownException {
        OperatedClientConnection wrappedConnection = getWrappedConnection();
        assertValid(wrappedConnection);
