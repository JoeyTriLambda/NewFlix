...
class SizeLimitedResponseReader {
    ...
    public SizeLimitedResponseReader(ResourceFactory resourceFactory, long j10, HttpRequest httpRequest, CloseableHttpResponse closeableHttpResponse) {
        ...
        this.maxResponseSizeBytes = j10;
        this.request = httpRequest;
        this.response = closeableHttpResponse;
    }

    private void doConsume() throws UnsupportedOperationException, IOException {
        ensureNotConsumed();
        this.consumed = true;
    ...
    public void readResponse() throws UnsupportedOperationException, IOException {
        if (this.consumed) {
            return;
        }
        doConsume();
