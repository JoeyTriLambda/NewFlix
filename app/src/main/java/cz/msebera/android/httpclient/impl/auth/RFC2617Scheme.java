...
public abstract class RFC2617Scheme extends AuthSchemeBase implements Serializable {
    ...
    public void parseChallenge(CharArrayBuffer charArrayBuffer, int i10, int i11) throws ParseException, MalformedChallengeException {
        HeaderElement[] elements = BasicHeaderValueParser.INSTANCE.parseElements(charArrayBuffer, new ParserCursor(i10, charArrayBuffer.length()));
        this.params.clear();
