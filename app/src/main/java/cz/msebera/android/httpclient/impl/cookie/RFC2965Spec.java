...
public class RFC2965Spec extends RFC2109Spec {
    ...
    private static CookieOrigin adjustEffectiveHost(CookieOrigin cookieOrigin) {
        ...
        while (true) {
            ...
            char cCharAt = host.charAt(i10);
            if (cCharAt == '.' || cCharAt == ':') {
                break;
            }
            i10++;
        }
        return z10 ? new CookieOrigin(host.concat(".local"), cookieOrigin.getPort(), cookieOrigin.getPath(), cookieOrigin.isSecure()) : cookieOrigin;
    }
